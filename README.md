> ## Simple Electron Video Recorder
>
> This is a simple Electron app designed to record videos through your webcam and save them locally on your file system. The application allows you to start and stop recording, save the recorded video, and play it back with standard video controls.
>
> ### Running the Application
>
> The easiest way to run this application is to follow these steps:
>
> 1. **Install Dependencies**: Navigate to the project directory and run the following command to install all necessary dependencies:
>
>    ```sh
>    npm install
>    ```
>
> 2. **Start the Application in Developer Mode**: After the dependencies are installed, run the following command to start the application in developer mode:
>
>    ```sh
>    npm run watch
>    ```
>
>    This will load the application with hot-reloading enabled, making it easier to develop and test.
>
> ### Important Notes
>
> - **File Persistence**: Currently, the recorded video files are saved to the file system. However, reloading the application will not reload the previously saved files, although they will still be present on the file system.
> - **Webcam Access**: Ensure that your webcam is connected and accessible by the application.
>
> Below is the default readme from the boilerplate used for this project:
